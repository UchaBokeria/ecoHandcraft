        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <p class="mt-5 text-gray-600">Already joined us? <a href="/signin" title="" class="text-black transition-all duration-200 hover:underline">Sign in</a></p>
                </div>

                <div>
                    <img class="w-full" src={nature} alt="" />
                </div>
            </div>
        </div>
    </section>

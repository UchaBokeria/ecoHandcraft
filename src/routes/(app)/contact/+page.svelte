<section class="py-10 bg-[#2ECC40] bg-opacity-10 sm:py-16 lg:py-24 ">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">Contact us</h2>
            <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">We'd love to hear from you! Whether you're interested in our products, want to collaborate, or simply share your thoughts about sustainability, your voice matters to us</p>
        </div>

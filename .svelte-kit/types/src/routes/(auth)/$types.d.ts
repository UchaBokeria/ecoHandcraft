...
type LayoutRouteId = RouteId | "/(auth)/changePassword/[email]/[resetToken]" | "/(auth)/reset" | "/(auth)/signin" | "/(auth)/signup"
type LayoutParams = RouteParams & { email?: string,resetToken?: string }
